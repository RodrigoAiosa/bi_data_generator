...
_TABS_GUIA_TEXTO = {
    "pt": (
        ...
        "- 🕰️ **Simulador de Dimensões Mutáveis** — simula a passagem do tempo numa dimensão do "
        "setor que você já gerou (cliente mudou de segmento, produto trocou de categoria...), com "
        "gabarito exato de quem mudou o quê e os 3 tratamentos clássicos de SCD (Tipo 1, 2 e 3) já "
        "prontos pra comparar.\n"
    ...
    "en": (
        ...
        "- 🕰️ **Mutable Dimensions Simulator** — simulates the passage of time on a dimension from "
        "the sector you already generated (a customer changed segment, a product changed category...), "
        "with an exact answer key of what changed and the 3 classic SCD treatments (Type 1, 2 and 3) "
...
def main() -> None:
    ...
    with tab_sandbox:
        render_dax_sandbox(setor, n_linhas, data_inicio, data_fim)
