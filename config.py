...
SETORES = {
    ...
    "☕️ Cafeicultura & Torrefação": "cafeicultura",
    "👟 Calçados": "calcados",
    ...
    "⚓️ Porto & Terminal Portuário": "porto",
    "⛽️ Posto de Combustível & Conveniência": "posto_combustivel",
...
SETORES_INFO = [
    ...
    ("☕️", "Cafeicultura & Torrefação", "Fazendas, lotes de café, colheita e torrefação"),
    ...
    ("⛵️", "Marina & Náutica", "Marinas, embarcações, vagas e atracações"),
    ...
    ("⚓️", "Porto & Terminal Portuário", "Terminais, navios, atracações e movimentação de carga"),
    ("⛽️", "Posto de Combustível & Conveniência", "Postos, combustíveis, abastecimentos e loja de conveniência"),
