...
SETORES_INFO_EN = [
    ...
    ("☕", "Coffee Farming & Roasting", "Farms, lots, harvest and roasting"),
    ...
    ("⛽", "Gas Station & Convenience Store", "Stations, fuels, fill-ups and convenience store sales"),
    ...
    ("⛵", "Marina & Boating", "Marinas, boats, slips and berthing"),
    ...
    ("⚓", "Port & Terminal Operations", "Terminals, ships, berthing and cargo handling"),
