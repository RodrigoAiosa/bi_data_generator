...
SETORES_INFO_EN = [
    ("🧊", "3D Printing & Prototyping", "Companies, printers, materials and orders"),
    ("🧮", "Accounting Firm", "Accountants, business clients, services and fees"),
    ("📢", "Advertising Agency", "Projects, media campaigns, team and clients"),
    ("🌾", "Agribusiness", "Harvests, crops, properties and inputs"),
    ("🌱", "AgTech", "IoT sensors, drones, monitoring and precision agriculture"),
    ("🛩️", "Air Taxi & Executive Aviation", "Aircraft, pilots, charter flights and maintenance"),
    ("🛫", "Airport Operations", "Airports, terminals, landings/takeoffs, airlines"),
    ("🎡", "Amusement Park", "Rides, tickets and ride usage"),
    ("🏛️", "Architecture & Design", "Projects, services, fees and construction management"),
    ("🔨", "Auction House", "Bids, lots, bidders and winning bids"),
    ("🎬", "Audiovisual & Production", "Productions, budgets, crew and box office"),
    ("🕵️", "Audit & Compliance", "Auditors, clients, findings and non-conformities"),
    ("🔧", "Auto Parts & Repair Shop", "Parts, services, customers and sales channels"),
    ("🥐", "Bakery & Pastry Shop", "Stores, products, sales and production"),
    ("💈", "Barbershop", "Barbers, units, services and subscription clubs"),
    ("💄", "Beauty & Aesthetics", "Sales, services, schedule and partner salons"),
    ("🐝", "Beekeeping", "Apiaries, hives, honey harvest and hive health"),
    ("🍹", "Beverage Distributor", "Distribution centers, brands, bar and market orders"),
    ("🚲", "Bike Sharing", "Stations, bikes, rides and plans"),
    ("🌽", "Biofuels", "Plants, feedstocks, production and fuel sales"),
    ("🧬", "Biotechnology", "Genomics, CRISPR, research and lab experiments"),
    ("🪙", "Blockchain & Cryptocurrency", "Transactions, coins, users and digital wallets"),
    ("🩸", "Blood Bank", "Units, donors, donations and blood types"),
    ("📕", "Bookstore", "Stores, books, genres and sales"),
    ("🚰", "Bottled Water", "Springs, bottled lines, production and distribution"),
    ("🎳", "Bowling & Family Entertainment", "Units, lanes, games and clients"),
    ("📊", "Business Consulting", "Projects, consultants, invoices and clients"),
    ("📞", "Call Center & BPO", "Calls, agents, customers and quality assessment"),
    ("🚙", "Car Dealership", "Sales, vehicles, salespeople and test drives"),
    ("🚗", "Car Rental", "Reservations, fleet, customers, fines and rates"),
    ("🍱", "Catering & Events", "Events, menus, suppliers and ceremonies"),
    ("🪦", "Cemetery & Perpetual Care", "Cemeteries, plots, burials and maintenance"),
    ("🧱", "Ceramic Tile Manufacturing", "Factories, product lines, production and sales"),
    ("🎥", "Cinema & Exhibition", "Screenings, movies, theaters and concessions"),
    ("♻️", "Circular Economy", "Recycling, reverse logistics, carbon credits and ESG"),
    ("🎪", "Circus & Traveling Shows", "Troupes, tours, shows and audience"),
    ...
    ("🧹", "Cleaning Services", "Staff, contracts, visits and supplies"),
    ("☕️", "Coffee Farming & Roasting", "Farms, lots, harvest and roasting"),
    ("⚗️", "Compounding Pharmacy", "Pharmacists, clients, compounded formulas and inputs"),
    ("🏢", "Condominium & Facilities", "Fees, expenses, incidents and maintenance"),
    ("🧾", "Consortiums (Group Buying Pools)", "Installments, awards, groups and members"),
    ("🏗️", "Construction", "Projects, costs, materials and suppliers"),
    ("💵", "Consumer Finance Lending", "Branches, clients, loan contracts and installments"),
    ("✈️", "Corporate Travel", "Travelers, costs, travel policy and SLA"),
    ("🧴", "Cosmetics Manufacturing", "Product lines, production, channels and sales"),
    ("🪑", "Coworking & Shared Spaces", "Bookings, subscriptions, spaces and clients"),
    ("🍺", "Craft Brewery", "Beer labels, points of sale, production and sales"),
    ("💳", "Credit Union", "Operations, members, products and distributed surplus"),
    ("🤝", "CRM", "Opportunities, accounts, contacts and sales activities"),
    ("💱", "Currency Exchange Bureau", "Exchange operations, currencies, quotes and service fees"),
    ("🪵", "Custom Furniture & Woodworking", "Contracts, projects, production and clients"),
    ("🛃", "Customs Brokerage", "Brokers, clients, import and export processes"),
    ("🔐", "Cybersecurity", "Incidents, vulnerabilities, assets and SLA response (SOC)"),
    ("🖥️", "Data Center & Cloud Hosting", "Usage, instances, customers and incidents"),
    ("👶", "Daycare & Early Childhood Education", "Units, classes, enrollments and tuition"),
    ("📇", "Debt Collection", "Debt portfolios, debtors and settlements"),
    ("🦷", "Dentistry", "Appointments, dentists, patients, procedures and health plans"),
    ("📣", "Digital Marketing", "Campaigns, channels, performance and conversions"),
    ("🚦", "Driving School", "Units, instructors, lessons and licensing exams"),
    ("🚁", "Drones & Aerial Services", "Missions, drones, maintenance and clients"),
    ("🏪", "E-commerce", "Orders, customers, products, shipping and payments"),
    ("📚", "Education", "Enrollments, students, courses and instructors"),
    ("📹", "Electronic Security & Monitoring", "Monitoring centers, clients, alarms and response time"),
    ("🔩", "Electronics Repair Service", "Work orders, technicians, parts and repairs"),
    ("🛗", "Elevator Maintenance", "Technicians, elevators, service calls and response time"),
    ("🚑", "Emergency Medical Transport", "Emergency calls, ambulances, crews and response time"),
    ("⚡", "Energy", "Consumption, meters, substations and tariffs"),
    ("📐", "Engineering Firm", "Offices, engineers, projects and contracts"),
    ("🛠️", "Equipment Rental", "Rentals, equipment, maintenance and clients"),
    ("🎉", "Events & Entertainment", "Tickets, suppliers, revenue and NPS"),
    ("🥬", "Farmers Market", "Vendors, stalls, sales and stall occupancy"),
    ...
    ("🏋️", "Fitness & Gym", "Check-ins, students, instructors, payments and physical assessments"),
    ("💐", "Florist", "Stores, products, sales and special orders"),
    ("🍔", "Food & Beverage", "Production, plants, products and suppliers"),
    ("🛵", "Food Delivery", "Partner restaurants, couriers, orders and ratings"),
    ("🌮", "Food Truck", "Trucks, menu, sales and events"),
    ("👟", "Footwear Manufacturing", "Factories, models, production and sales by channel"),
    ("🌐", "Foreign Trade", "Products, countries, imports and exports"),
    ("🌲", "Forestry & Paper", "Stands, species, harvest and carbon credits"),
    ("🏷️", "Franchises", "Units, royalties, fees and revenue"),
    ("🚂", "Freight Railway", "Locomotives, terminals, cargo trips and maintenance"),
    ("💹", "Fund & Asset Management", "Funds, unit holders, inflows and redemptions"),
    ("⚰️", "Funeral Home Services", "Services, plans, preventive contracts and clients"),
    ("🛋️", "Furniture Manufacturing", "Products, machines, production and sales"),
    ("🎮", "Games & eSports", "Matches, players, games and in-game monetization"),
    ("⛽️", "Gas Station & Convenience Store", "Stations, fuels, fill-ups and convenience store sales"),
    ("🪟", "Glass Manufacturing", "Factories, glass products, orders and installation"),
    ("🏛️", "Government & Public Sector", "Expenditures, revenues, tenders and contracts"),
    ("🌾", "Grain Elevator & Storage", "Warehouses, producers, receiving and grain grading"),
    ("🧶", "Handicrafts", "Artisans, products, sales by channel and production"),
    ("🗂️", "Health Insurance Operator", "Members, plans, providers, authorizations and premiums"),
    ("🏥", "Healthcare", "Visits, patients, physicians and procedures"),
    ("🎓", "Higher Education", "Enrollments, courses, majors and academic performance"),
    ("🩺", "Home Care", "Visits, patients, professionals and incidents"),
    ("🏨", "Hospitality", "Reservations, guests, hotels, rooms and channels"),
    ("🏢", "Human Resources", "Hours worked, employees, projects and roles"),
    ("🍦", "Ice Cream Manufacturing", "Factories, flavors, production and sales"),
    ("🛠️", "Industrial Maintenance", "Technicians, clients, work orders and parts"),
    ("✅", "Inspection & Certification", "Inspectors, client companies, audits and certifications"),
    ("🛡️", "Insurance", "Policies, insureds, brokers and claims"),
    ("🚍", "Intercity Bus Line", "Companies, routes, trips and passengers"),
    ("📈", "Investment Brokerage", "Advisors, clients, assets, orders and portfolios"),
    ("💍", "Jewelry & Watches", "Sales, products, customers and repair service"),
    ("🔬", "Laboratory & Diagnostics", "Tests, patients, results and health plans"),
    ("🗣️", "Language School", "Teachers, students, courses, enrollments and proficiency tests"),
    ("🧺", "Laundry Services", "Units, B2B clients, orders and incidents"),
    ("⚖️", "Legal", "Cases, lawyers, clients and courts"),
    ("🐄", "Livestock Farming", "Farms, herds, management and production"),
    ("🚚", "Logistics", "Deliveries, carriers, routes and customers"),
    ("🎫", "Lottery Retailer & Banking Correspondent", "Transactions, lottery bets, units and services"),
    ("🏭", "Manufacturing", "Production, machines, inputs and operators"),
    ("⛵️", "Marina & Boating", "Marinas, boats, slips and berthing"),
    ("🥩", "Meatpacking & Processing", "Slaughter, products, plants and sales channels"),
    ("🧠", "Mental Health", "Sessions, professionals, patients and diagnoses"),
    ("⚙️", "Metallurgy & Steel Industry", "Production, furnaces, products and sales"),
    ("⚒️", "Metalwork & Locksmith", "Clients, products, orders and production"),
    ("⛏️", "Mining", "Extractions, mines, minerals and equipment"),
    ("🚗", "Mobility", "Rides, drivers, passengers, routes and vehicles"),
    ("🏍️", "Motorcycle Courier & Ride App", "Riders, clients and delivery/passenger trips"),
    ("🖼️", "Museums & Culture", "Visits, exhibitions, cultural events and tickets"),
    ("🎼", "Music School", "Teachers, students, instruments, lessons and enrollments"),
    ("🔥", "Natural Gas Utility", "Distributors, connections, consumption and bills"),
    ("📰", "News Agency", "Journalists, articles, subscriber outlets and distribution"),
    ("🪩", "Nightclub & Live Venue", "Venues, events, tickets and bar consumption"),
    ("🤲", "Nonprofit & NGOs", "Donations, social projects, donors and execution"),
    ("📜", "Notary & Registry Office", "Notarial acts, notaries, clients and protests"),
    ("👵", "Nursing Home", "Institutions, residents, caregivers and health incidents"),
    ("🦺", "Occupational Safety & SESMT", "Client companies, occupational exams and safety training"),
    ("🛢️", "Oil & Gas", "Production, wells, platforms and operating costs"),
    ("👓", "Optical Store", "Sales, products, customers and eye exams"),
    ("📦", "Packaging Manufacturer", "Products, B2B clients, production and orders"),
    ("🅿️", "Parking & Metered Zones", "Entries, parking lots, customers and fines"),
    ("🐜", "Pest Control", "Technicians, clients, work orders and pest type"),
    ("🐾", "Pet & Veterinary", "Appointments, pets, owners and veterinary services"),
    ("💊", "Pharmaceutical", "Products, reps, sales and inventory"),
    ("🦵", "Physical Therapy & Rehab", "Clinics, therapists, patients and sessions"),
    ("🌳", "Plant Nursery & Landscaping", "Plants, clients, sales and landscaping projects"),
    ("🧪", "Plastics Manufacturing", "Factories, plastic products, production and sales"),
    ("🏊", "Pool & Spa Maintenance", "Services, clients, technicians and chemical consumption"),
    ("⚓️", "Port & Terminal Operations", "Terminals, ships, berthing and cargo handling"),
    ("📦", "Postal & Parcel Service", "Shipments, branches, services and incidents"),
    ("🐔", "Poultry Farming", "Farms, flocks, production and mortality"),
    ("🖨️", "Print Shop & Visual Communication", "Orders, production, products and clients"),
    ("🔒", "Private Security", "Shifts, guards, clients and incidents"),
    ("📰", "Public Relations", "Clients, media outlets, retainers and press clipping"),
    ("📖", "Publishing House", "Books, sales, channels and inventory"),
    ("🎙️", "Radio & Podcast", "Shows, hosts, audience and ad sales"),
    ("🏠", "Real Estate", "Sales, rentals, properties and agents"),
    ("🏙️", "Real Estate Developer", "Developments, units, off-plan sales and payment terms"),
    ("🗑️", "Recycling & Waste Management", "Collections, materials, cooperatives and material sales"),
    ("🔁", "Reinsurance", "Ceding insurers, treaties and reinsured claims"),
    ("⛪", "Religious Organization", "Members, ministries, tithes and services"),
    ("🍽️", "Restaurants & Food Service", "Orders, menu, units, reservations and delivery"),
    ("🛒", "Retail", "Sales, customers, products and branches"),
    ("🤖", "Robotics & Industrial Automation", "Client plants, robots and automation projects"),
    ("☁️", "SaaS B2B", "Subscriptions, MRR, churn, NPS and plans"),
    ("🚌", "School Transportation", "Vehicles, drivers, students, routes and monthly fees"),
    ("🚢", "Shipbuilding", "Shipyards, vessels, construction milestones and maintenance"),
    ("🏬", "Shopping Mall Management", "Malls, tenants, rent and visitor traffic"),
    ("🎾", "Social & Recreation Club", "Clubs, members, facilities and dues"),
    ("☀️", "Solar Energy", "Installations, clients, generation and PV projects"),
    ("🚀", "Space & Aerospace", "Missions, satellites, launches and operations"),
    ("🏟️", "Sports", "Matches, athletes, clubs and competitions"),
    ("🎰", "Sports Betting & iGaming", "Bets, players, sporting events and transactions"),
    ("🏟️", "Stadium & Arena", "Arenas, events, tickets and box office"),
    ("🦄", "Startups & Venture Capital", "Funding rounds, valuations, MRR and growth metrics"),
    ("📎", "Stationery & School Supplies", "Sales, products, stores and inventory"),
    ("🎬", "Streaming", "Plays, subscribers, content, artists"),
    ("🎁", "Subscription Box Club", "Subscribers, themed boxes, plans and shipments"),
    ("🚇", "Subway & Urban Rail", "Validations, stations, lines and incidents"),
    ("🍬", "Sugar & Ethanol Mill", "Mills, cane fields, crushing and production"),
    ("🟫", "Tannery & Leather", "Tanneries, leather lots, processing and sales"),
    ("🖋️", "Tattoo Studio", "Tattoo artists, clients, sessions and touch-ups"),
    ("💻", "Technology", "SaaS contracts, customers and plans"),
    ("📡", "Telecom", "Calls, subscribers, plans and towers"),
    ("🖥️", "Telemedicine", "Doctors, patients, virtual visits and prescriptions"),
    ("📝", "Test-Prep School", "Teachers, students, enrollments and mock exams"),
    ("🧵", "Textile & Apparel Mfg", "Fibers, production, machine efficiency and clients"),
    ("🏝️", "Timeshare", "Resorts, units, owners, bookings and fees"),
    ("🛞", "Tire Manufacturing", "Factories, tire models, production and sales"),
    ("🛣️", "Toll Road Concession", "Concessionaires, toll plazas, passages and revenue"),
    ("✈️", "Tourism", "Trips, packages, agencies and destinations"),
    ("🪀", "Toy Manufacturing", "Toy lines, production and store orders"),
    ("🪧", "Trade Union & Professional Association", "Members, categories, dues and benefits"),
    ("🚛", "Transportation", "Trips, fleet, fuel, maintenance and profitability"),
    ("🚴", "Urban Logistics", "Last-mile deliveries, couriers and SLA"),
    ("🏖️", "Vacation Rental", "Bookings, properties, guests and reviews"),
    ("🥤", "Vending Machines", "Machines, products, sales and restocking"),
    ("🧰", "Vocational & Technical School", "Units, technical courses, students and internships"),
    ("🏬", "Warehousing & Self Storage", "Facilities, storage units, contracts and incidents"),
    ("💧", "Water & Sanitation", "Consumption, bills, treatment plants and connections"),
    ("🛍️", "Wholesale & Cash-and-Carry", "Stores, bulk products, B2B sales and clients"),
    ("🍷", "Winery & Viticulture", "Production, vineyards, wines and sales channels"),
    ("🦁", "Zoo & Aquarium", "Enclosures, animals, tickets and animal care"),
]
