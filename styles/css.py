...
/* ══════════════════════════════════════════════════════════════════════
   DASHBOARD — estilo "documento/papel" (aplicado só na aba Dashboard,
   via st.container(key="dash_paper"), que o Streamlit renderiza como
   .st-key-dash_paper). O resto do app continua no tema Power BI.
   ══════════════════════════════════════════════════════════════════════ */
.st-key-dash_paper {
    background: #EEF0EA;
    border-radius: 14px;
...
.st-key-dash_paper * { box-sizing: border-box; }

/* -- Cabeçalho estilo "relatório impresso" -- */
.dash-header {
    background: #16233F;
    color: #EEF0EA;
...
.dash-tear {
    ...
    background-image: radial-gradient(circle at 8px 8px, #EEF0EA 6px, transparent 6.5px);
    background-size: 20px 16px;
    background-repeat: repeat-x;
}

/* -- Corpo: reserva o padding lateral que o header já tem -- */
.st-key-dash_paper > div > div > [data-testid="stVerticalBlock"] {
    padding-left: 2.2rem;
    padding-right: 2.2rem;
}

/* -- Títulos de seção (h3.section-header vem do markdown das _dash_X) -- */
.st-key-dash_paper h3.section-header,
.st-key-dash_paper h3.section-header-plain {
    font-family: 'Bitter', serif !important;
    color: #16233F !important;
    border-bottom-color: #D8DAD0 !important;
    margin-top: 2rem !important;
}
.st-key-dash_paper h3.section-header::after { background: #B8862E !important; }

/* -- KPIs em formato de selo/carimbo -- */
.kpi-stamp {
    background: #F8F9F4;
    border: 2px double #16233F;
    border-radius: 4px;
    padding: 1rem 1.1rem 0.9rem;
    height: 100%;
}
.st-key-dash_paper [data-testid="stHorizontalBlock"] > [data-testid="column"]:nth-child(odd) .kpi-stamp {
    transform: rotate(-0.4deg);
}
.st-key-dash_paper [data-testid="stHorizontalBlock"] > [data-testid="column"]:nth-child(even) .kpi-stamp {
...
/* -- Cards de gráfico -- */
.st-key-dash_paper [data-testid="stPlotlyChart"] {
    background: #F8F9F4;
